"""
This code implements the Q-Learning algorithm to solve a cliff walking problem.
...
for episode in range(num_episodes):
    ...
    while True:
        ...
        next_action_max_Q = transitions[*next_state][np.argmax(Q[*next_state][transitions[*next_state]])]
